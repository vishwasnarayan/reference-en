...
WRITE A PROGRAM TO BUILD A PWM BASED LED.
WRITE A PROGRAM TO WRITE THE RGB VALUE OF THE VARIYING LED IN THE SERIAL WINDOW(THE VALUE OF THE BRIGHTNESS).
WRITE A PROGRAM TO GET THE POTENTIOMETER READING BASED ON THE ARDUINO WHICH IS VARIYING AS WE TURN AND PRINT IT WITH THE SERIAL WINDOW AND SERIAL PLOTTER.
--
